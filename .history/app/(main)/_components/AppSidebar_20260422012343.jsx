...
import { Menu, ArrowLeft } from 'lucide-react';
  ...
  return (
    <Sidebar collapsible="icon">
      <SidebarHeader className="flex flex-col items-center px-3 py-4 relative w-full">
        <button
          aria-label={collapsed ? 'Expand sidebar' : 'Collapse sidebar'}
          className="absolute left-2 top-2 z-10 p-1 rounded hover:bg-gray-200 transition"
        ...
        {collapsed ? (
          <Image
            ...
            width={40}
            height={40}
            className='w-10 h-10 mx-auto mt-6 mb-2'
          />
        ) : (
          <Image
            src="/logo.png"
