...
const InterviewCard = ( {interview} ) => {
    ...
    const onSend = () => {
        window.location.href = `mailto:?subject=Interview Link&body=Please join the interview using this link: ${process.env.NEXT_PUBLIC_HOST_URL + "/" + interview?.interview_id}`;
    }
  return (
