...
const FormContainer = ({onHandleInputChange, GoToNext}) => {
  ...
  return (
    <div className='p-5 bg-gray-100 rounded-xl'>
      ...
      <div className='mt-5'>
        <h2 className='text-sm font-medium'>Interview Date</h2>
        <Input
          type="date"
          className='mt-2'
          onChange={(e) => onHandleInputChange('date', e.target.value)}
        />
      </div>
      <div className='mt-5'>
        <h2 className='text-sm font-medium'>Interview Time</h2>
        <Input
          type="time"
          className='mt-2'
          onChange={(e) => onHandleInputChange('time',  e.target.value)}
        />
      </div>
