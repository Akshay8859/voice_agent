            ...
            <DialogContent>
                ...
                <DialogDescription asChild>
                    <div className='mt-5'>
                        ...
                        <div className={`p-5 ${feedback?.recommendation == 'Not Recommended' ? 'bg-red-100' : 'bg-green-100'} mt-5 rounded-md`}>
                            <h2 className={`${feedback?.recommendation == 'Not Recommended' ? 'text-red-700' : 'bg-green-700'}`}>Recommendation Msg: </h2>
                            <p className={`${feedback?.recommendation == 'Not Recommended' ? 'bg-red-500' : 'bg-green-500'}`}>{feedback?.recommendationMsg}</p>
                        </div>
                    </div> 
                </DialogDescription>
                </DialogHeader>
