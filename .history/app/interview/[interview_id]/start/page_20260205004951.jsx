...
const StartInterview = () => {
    ...
    console.log("interviewInfo", interviewInfo.interviewContent);
    ...
    useEffect(() => {
        const handleMessage = (message) => {
            ...
            if(message?.conversation){
                const convoString = message.conversation;
    ...
    const GenerateFeedback = async () => {
        setLoading(true);
            console.log("Sending conversation to backend:", conversation, Array.isArray(conversation));
        if (!Array.isArray(conversation) || conversation.length === 0) {
            toast("No conversation data to send!");
            setLoading(false);
            return;
        }
