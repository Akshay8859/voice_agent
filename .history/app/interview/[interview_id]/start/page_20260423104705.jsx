...
const StartInterview = () => {
  ...
  return (
    <div className="relative min-h-screen bg-[#23272f] flex flex-col justify-between">
            {/* Top bar with timer */}
            ...
            {/* Main call area */}
            <div className="flex-1 flex items-center h-[800vh] justify-center relative">
            ...
            <div className="w-full flex items-center justify-center gap-6 py-6 bg-[#23272f] border-t border-gray-800">
            ...
            <h2 className='text-center text-sm text-gray-400 mt-2 animate-pulse'>Interview in Progress...</h2>
        </div>
