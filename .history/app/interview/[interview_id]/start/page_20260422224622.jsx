        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-7 mt-5'>
            ...
            <div className='bg-gray-100 h-[400px] rounded-lg border flex flex-col gap-3 items-center justify-center'>
                <div className='relative items-center justify-center flex flex-col'>
                    ...
                    {/* <div className="w-[120px] h-[120px] rounded-full overflow-hidden border-2 border-primary bg-black flex items-center justify-center mb-2"> */}
                        <video
                            ref={videoRef}
                            autoPlay
                            playsInline
                            muted
                            className="w-full h-full r object-center"
                        />
                    {/* </div> */}
                </div>
