...
import { CircleDot, Loader2Icon, Mic, MicOff, Phone, Timer, Video, VideoOff } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#f6f7fa] flex flex-col">
      ...
      <div className="flex items-center justify-between px-8 py-4 bg-white shadow">
        <div className="flex items-center gap-2">
          ...
          <span className="ml-4 text-lg font-bold text-[#7c3aed]">AI Interview</span>
        </div>
        <div className="flex items-center gap-3">
          <div className="flex flex-col items-end">
            <span className="font-semibold">Andrews M.</span>
        ...
        <div className="bg-white rounded-2xl shadow-xl w-full max-w-6xl flex flex-col p-0">
          ...
          <div className="flex items-center justify-between px-8 pt-6 pb-2">
            <div className="flex items-center gap-2">
              ...
              {/* Add tags as needed */}
              <span className="ml-2 px-2 py-1 bg-gray-100 rounded text-xs">UI UX Designer</span>
              <span className="ml-2 px-2 py-1 bg-gray-100 rounded text-xs">Plum technologies</span>
            </div>
            <div className="flex items-center gap-4">
              <Cl
              ock className="w-5 h-5 text-gray-500" />
              <span className="text-green-700 font-semibold">Interview Time Left</span>
          ...
          <div className="flex gap-6 px-8 pb-8 pt-2">
            ...
            <div className="flex-1 flex flex-col items-center">
              <div className="relative w-full aspect-video bg-black rounded-xl overflow-hidden flex items-center justify-center">
                ...
                <div className="absolute bottom-4 left-4 flex items-center gap-2">
                  <button
                    className={`p-2 rounded-full ${micEnabled ? 'bg-green-100' : 'bg-red-100'}`}
                    onClick={handleToggleMic}
                  >
            ...
            <div className="w-[340px] flex flex-col gap-4">
              ...
              <div className="bg-white rounded-xl p-5 shadow flex flex-col items-center gap-2">
                <span className="font-semibold text-gray-700">AI Interviewer</span>
