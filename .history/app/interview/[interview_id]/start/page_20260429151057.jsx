      ...
      <div className="flex-1 flex items-center justify-center py-8 px-2">
        <div className="bg-white rounded-2xl shadow-xl w-full max-w-6xl flex flex-col p-0">
          ...
          <div className="flex gap-6 px-8 pb-8 pt-2">
            ...
            <div className="bg-white rounded-xl p-5 shadow flex flex-col items-center gap-2 w-[340px] mt-4">
              ...
              <>
                ...
                {showAll && (
                  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
                    <div className="bg-white rounded-2xl shadow-xl max-w-lg w-full p-6 relative">
                      ...
                      <h3 className="text-lg font-bold mb-4 text-center">All Questions</h3>
                      <div className="flex flex-col gap-4 max-h-[60vh] overflow-y-auto">
                        {questions.map((item, idx) => (
                          <div key={idx} className="border-b pb-2">
                            <span className="font-semibold text-green-700">Question {idx + 1} of {questions.length}</span>
                ...
                <div className="bg-gray-50 rounded-xl p-5 shadow flex flex-col gap-2 relative w-[340px]">
                  <div className="flex items-center justify-between">
                    <span className="font-semibold text-green-700">Question {current + 1} of {questions.length}</span>
                    <button
