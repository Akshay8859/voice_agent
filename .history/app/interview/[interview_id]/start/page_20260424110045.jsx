            ...
            <div className="flex-1 flex flex-col items-center">
              <div className="relative w-full aspect-video bg-black rounded-xl overflow-hidden flex items-center justify-center">
                ...
                <div className="absolute bottom-4 left-4 flex items-center gap-2">
                  ...
                  >
                        {activeUser == 1 && <span className="absolute w-48 h-48 rounded-full bg-primary opacity-30 animate-ping" />}
            ...
            <div className="w-[340px] flex flex-col gap-4">
              ...
              <div className="bg-white rounded-xl p-5 shadow flex flex-col items-center gap-2">
                <span className="font-semibold text-gray-700">
                  {activeUser === 1 ? 'AI Interviewer' : activeUser === 2 ? `${interviewInfo?.userName} (You)` : 'AI Interviewer'}
                </span>
                <div className="flex items-center gap-2 mt-2">
                  {activeUser === 1 && <SpeakingIcon size={24} color="#A3D86E" />}
