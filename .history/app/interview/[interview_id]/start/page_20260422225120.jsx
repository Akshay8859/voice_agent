  ...
  return (
    <div className='p-20 lg:px-48 xl:px-56'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-7 mt-5'>
            ...
            <div className='bg-gray-100 h-full rounded-lg border flex flex-col gap-3 items-center justify-center'>
                <div className='relative items-center justify-center flex flex-col'>
                    {/* {activeUser == 2 && <span className='absolute inset-0 rounded-full bg-primary opacity-75 animate-ping' />} */}
                    <div className="w-full h-full overflow-hidden flex items-center justify-center mb-2">
                        <video
                            ref={videoRef}
                            autoPlay
                            playsInline
