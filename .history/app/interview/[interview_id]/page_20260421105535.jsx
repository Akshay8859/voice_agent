    ...
    <div className='px-10 md:px-28 lg:px-48 xl:px-64 mt-16'>
        <div className='flex flex-col items-center justify-center border rounded-lg bg-gray-100 p-7 lg:px-33 xl:px-52 mb-20'>
            ...
            <div className='flex items-center gap-5'>
                <h2 className='flex gap-2 items-center text-gray-500 mt-3'><Calendar className='h-4 w-4'/> {moment(interviewData?.date).format('MMM DD, yyyy')}</h2>
                <h2 className='flex gap-2 items-center text-gray-500 mt-3'><Timer className='h-4 w-4'/> {moment(interviewData?.time).format('h:mm A')}</h2>
                <h2 clas    sName='flex gap-2 items-center text-gray-500 mt-3'><Clock className='h-4 w-4'/> {interviewData?.duration}</h2>
            </div>
