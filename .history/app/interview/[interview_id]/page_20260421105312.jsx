...
import { Calendar, Clock, Info, Loader2Icon, Video } from 'lucide-react'
    ...
    <div className='px-10 md:px-28 lg:px-48 xl:px-64 mt-16'>
        <div className='flex flex-col items-center justify-center border rounded-lg bg-gray-100 p-7 lg:px-33 xl:px-52 mb-20'>
            ...
            <div className='flex items-center gap-5'>
                ...
                <h2 className='flex gap-2 items-center text-gray-500 mt-3'><Time className='h-4 w-4'/> {moment(interviewData?.date).format('MMM DD, yyyy')}</h2>
            </div>
