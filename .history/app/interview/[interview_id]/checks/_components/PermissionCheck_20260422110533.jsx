...
const PermissionCheck = () => {
  ...
  const joinInterview = () => {
    if (permission.camera && permission.microphone) {
      ...
      setError('Please grant both camera and microphone permissions to proceed.');
    }
  };


  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] bg-gradient-to-br from-orange-50 to-orange-100 py-8 px-4">
      <div className="bg-white shadow-xl rounded-2xl p-8 w-full max-w-md flex flex-col items-center border border-orange-100">
        ...
        <Button className="mt-4" onClick={() => joinInterview()}>Start Interview</Button>
      </div>
    </div>
  );
};
