...
const PermissionCheck = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] bg-gradient-to-br from-blue-50 to-blue-100 py-10 px-4">
      <div className="bg-white shadow-xl rounded-2xl p-8 w-full max-w-md flex flex-col items-center border border-blue-100">
        <h2 className="text-2xl font-bold mb-2 text-primary flex items-center gap-2">
          <Video className="w-6 h-6 text-blue-500" /> System Check
        </h2>
